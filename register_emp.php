...
<body>  
    ...
    <center><h1>REGISTER AN EMPLOYEE</h1></center>  
...
{ // echo "hii";
if(!empty($_POST['user']) && !empty($_POST['emp_last_name'])  && !empty($_POST['emp_first_name']) && !empty($_POST['designation_id']) && !empty($_POST['email_id'])
 ...
 //echo "heya";
    ...
    $con=mysqli_connect('localhost','root','atche841580','mess_management') or die(mysql_error());  
